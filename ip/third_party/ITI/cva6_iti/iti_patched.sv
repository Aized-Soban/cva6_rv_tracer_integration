...
module iti #(
  ...
  for (genvar i = 0; i < CVA6Cfg.NrCommitPorts; i++) begin
    itype_detector #(
        ...
        .pending_branch_i   (rvfi_to_iti_i.pending_branch),
        .branch_taken_i     (rvfi_to_iti_i.is_taken[i]),
        .branch_fifo_empty_i(rvfi_to_iti_i.branch_fifo_empty),
        .pc_i               (rvfi_to_iti_i.pc[i]),
        .disc_pc_i          (rvfi_to_iti_i.disc_pc),
        .cf_type_i          (rvfi_to_iti_i.cf_type),
        .itype_o            (itype[i])
    );
