...
(
    ...
    */
    ...
    //logic [$clog2(N**3)-1:0]                served;   ////log2 of N=1 will cause trouble
    //logic [$clog2(N**3)-1:0]                to_serve; //log2 of N=1 will cause trouble
    logic [$clog2(N**3):0]                served;
    logic [$clog2(N**3):0]                to_serve; 
